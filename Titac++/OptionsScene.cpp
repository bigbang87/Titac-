...
OptionsScene::OptionsScene(sf::RenderWindow & windows, GameDelegate & gameDelegate) : Scene(windows, gameDelegate)
{
}

void OptionsScene::onInitialize()
{
	//title
	std::unique_ptr<UIText> textPtr = std::make_unique<UIText>(sf::IntRect(74, 0, 50, 50), "archive.otf");
	std::string testText = "Options";
